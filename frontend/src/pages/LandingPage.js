    ...
    <div className='snap-y w-full h-[100vh]'>
      <div className='h-[100vh] w-full bg-[#FFD9C0] align-middle flex flex-col lg:flex-row items-center justify-center snap-start'>
            ...
            <div className='flex flex-col items-center justify-center'>
              ...
              <h1 className='text-[#2f2e41] text-4xl font-bold w-3/4 lg:text-5xl mt-4 text-center'>Welcome to <span className='text-[#fd2f6e]'>Co</span><span className='text-[#fe5740]'>Dev</span>!</h1>
              <p className='text-[#2f2e41] mt-12 text-2xl font-semibold w-2/3 text-center'>A place to collaborate with fellow developers across the world!!</p>
            </div>
      </div>
      <div className='h-[100vh] w-full align-middle flex flex-col lg:flex-row items-center justify-center snap-start'>
        <img src={landing2} className='h-44 md:h-60 lg:h-64' alt=''/>
            <div className='flex flex-col items-center justify-center lg:w-1/2'>
              ...
              <p className='text-[#2f2e41] text-xl font-semibold w-2/3 mt-6 lg:text-2xl text-center'>Join us to connect with some of the best developers and collaborate to turn your idea into reality!</p>
